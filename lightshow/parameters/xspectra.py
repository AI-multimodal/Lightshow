...
class XSpectraParameters(MSONable, _BaseParameters):
    ...
    psp_cutoff_table  : str
        The name of the cutoff table to loop around the pseudo potentials, the format
        should be the same as the one for SSSP database. The cutoff table shoyld be
        placed under the psp_directory.
    psp_json : str
        The name of the compact pseudo potential database in a single json file, which
        can be generated by the packPsps method. If not None, the json file should be
        placed under the psp_directory.
    """
    ...
    def __init__(
        ...
        if psp_directory is None or self._psp_cutoff_table is None:
            warn(
                ...
                "environment variables OR psp_cutoff_table not provided. neutral "
                "pseudo potential files will not be written."
            )
    ...
    def packPsps(self, pspJsonOut):
        ...
        files is better than copying them from self._psp_directory to the working
        directory.
    ...
    def _unpackPsps(
        ...
        """Used to generate the pseudo potential files from the compact json file.
        ...
        folder : str
            name of the folder where the pseudo potential files will be recovered
