...
def pspAdd(js, pspjs):
    ...
    pspjs[filename] = base64.b64encode(
    ...
    pspjs[filename + "_" + "wfc"] = base64.b64encode(
        bz2.compress(wfcString.encode("utf-8"), 9)
    ).decode("utf-8")
    ...
    #        pspjs[ filename + '_' + wfcShell[i] ] =
    #                              base64.b64encode(bz2.compress(wfcString.encode("utf-8"),9)).decode("utf-8")
    #        wfchash = hashlib.md5( wfcString.encode("utf-8") ).hexdigest()
